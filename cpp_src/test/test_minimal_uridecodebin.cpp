...
static void on_pad_added(GstElement *element, GstPad *pad, gpointer data) {
    std::cout << "*** PAD-ADDED CALLBACK TRIGGERED! ***" << std::endl;
    ...
    std::cout << "Linked pad to fakesink" << std::endl;
}
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Testing uridecodebin with URI: " << uri << std::endl;
    ...
    g_signal_connect(uridecodebin, "pad-added", G_CALLBACK(on_pad_added), pipeline);
    ...
    if (pad_added_called) {
        std::cout << "✅ SUCCESS: pad-added callback was triggered!" << std::endl;
        return 0;
    } else {
        std::cout << "❌ FAILURE: pad-added callback was NOT triggered!" << std::endl;
        return 1;
    }
}